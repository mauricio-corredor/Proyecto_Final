...
let AppController = class AppController {
    ...
    async create(appDto) {
        const appEntity = (0, class_transformer_1.plainToInstance)(app_entity_1.AppEntity, appDto);
        return await this.appService.create(appEntity);
    }
    async update(id, appDto) {
        const appEntity = (0, class_transformer_1.plainToInstance)(app_entity_1.AppEntity, appDto);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, app_dto_1.AppDto]),
    __metadata("design:returntype", Promise)
